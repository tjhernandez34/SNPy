jQuery(document).ready(function($) {
    ...
    var root = window.sunburstTopData;
    console.log("data for top", root);
    var width = 960,
        height = 740,
    ...
    function createSunburst(url) {
        ...
        var svg = d3.select("#zoomable_sunburst_angular_top").append("svg")
            .attr("width", width)
        ...
        var tooltip = d3.select("#zoomable_sunburst_angular_top")
            .append("div")
            .attr("class", "tooltip")
        ...
        function buildLegend(clickedObject) {
            ...
            var legendContainer = d3.select("#zoomable_sunburst_angular_top")
                .insert("svg")
                .attr("class", "legend")
        ...
        function click(d) {
            ...
            console.log("top sunburst clicked this object", d);
