jQuery(document).ready(function($) {
    ...
    var root = window.sunburstData;
    console.log("data for whole:", root);
    var width = 960,
        height = 740,
    ...
    function createSunburst(url) {
        ...
        var svg = d3.select("#zoomable_sunburst_angular_zoom").append("svg")
            .attr("width", width)
        ...
        var tooltip = d3.select("#zoomable_sunburst_angular_zoom")
            .append("div")
            .attr("class", "tooltip")
        ...
        function buildLegend(clickedObject) {
            ...
            var legendContainer = d3.select("#zoomable_sunburst_angular_zoom")
                .insert("svg")
                .attr("class", "legend")
