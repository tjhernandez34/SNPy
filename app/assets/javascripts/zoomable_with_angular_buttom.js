jQuery(document).ready(function($) {
    ...
    function createSunburst(url) {
        ...
        var svg = d3.select("#zoomable_sunburst_angular_buttom").append("svg")
            .attr("width", width)
            .attr("height", height)
            .append("g")
        ...
        var tooltip = d3.select("#zoomable_sunburst_angular_buttom")
            .append("div")
            .attr("class", "tooltip")
        ...
        // d3.json(url, function(error, root) {
            ...
            function buildLegend(clickedObject) {
                ...
                var legendContainer = d3.select("#zoomable_sunburst_angular_buttom")
                    .append("svg")
                    .attr("class", "legend")
                    .attr("width", 200)
                    .attr("height", 300);
